...
class planner_geofenceRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type planner_geofenceRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type planner_geofenceRequest
    let len;
    let data = new planner_geofenceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new planner_geofenceRequest(null);
...
class planner_geofenceResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type planner_geofenceResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type planner_geofenceResponse
    let len;
    let data = new planner_geofenceResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new planner_geofenceResponse(null);
...
module.exports = {
  Request: planner_geofenceRequest,
  Response: planner_geofenceResponse,
  md5sum() { return 'dc6345ad327f5b0036d6747623b84599'; },
  datatype() { return 'planner_msgs/planner_geofence'; }
};
