...
QT_INIT_METAOBJECT const QMetaObject voxblox_rviz_plugin::VoxbloxMeshDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<voxblox_msgs::Mesh>::staticMetaObject,
    qt_meta_stringdata_voxblox_rviz_plugin__VoxbloxMeshDisplay.data,
    qt_meta_data_voxblox_rviz_plugin__VoxbloxMeshDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
