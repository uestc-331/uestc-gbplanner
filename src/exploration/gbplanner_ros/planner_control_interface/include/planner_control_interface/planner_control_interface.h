...
class PlannerControlInterface {
 ...
 private:
  ...
  ros::Subscriber initialization_sub_;
  ros::Subscriber go_to_waypoint_sub_;
  ...
  void startPlannerTopicCallback(const std_msgs::Empty& msg);
  void stopPlannerTopicCallback(const std_msgs::Empty& msg);
  void homingTopicCallback(const std_msgs::Empty& msg);
  void initializationTopicCallback(const std_msgs::Empty& msg);
  void goToWaypointTopicCallback(const std_msgs::Empty& msg);
  void globalPlannerTopicCallback(const std_msgs::Int32& msg);
  void resetPlanner();
