...
vehicle_num = rospy.get_param('vehicle_num', default=1)
...
def gazebo_model_state_callback(msg):
    for vehicle_id in range(vehicle_num):
        ...
        multi_speed[vehicle_id].vector = msg.twist[id].linear
...
if __name__ == '__main__':
    ...
    for i in range(vehicle_num):
        ...
        multi_odom_pub[i] = rospy.Publisher(vehicle_type+'_'+str(i)+'/sim_tool/odometry', Odometry, queue_size=1)
